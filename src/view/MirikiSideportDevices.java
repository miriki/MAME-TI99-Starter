...
public class MirikiSideportDevices {

    // --------------------------------------------------
    
    private static final Logger log = LoggerFactory.getLogger(MirikiSideportDevices.class);
...
class SideportDevice {
    ...
    public SideportDevice( String comboName, String prettyTitle, String cardComment ) {
		...
		log.debug( "[constructor] SideportDevice()" );
